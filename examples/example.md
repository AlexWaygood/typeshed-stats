...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 818
    - Unannotated parameters: 365
    - Explicit `Any` parameters: 19
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 310
- Returns:
