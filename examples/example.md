...
- Variables:
    ...
    - Explicit `Any` variables: 0
    - Explicitly `Incomplete` (or partially `Incomplete`) variables: 272
- Class definitions:
    - Total class definitions: 91
    - Class definitions with `Any`: 3
    - Class definitions marked as at least partially `Incomplete`: 0
