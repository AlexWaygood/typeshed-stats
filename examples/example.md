...
Typeshed currently has 1 unique allowlist entry for `Pillow` when running stubtest in CI.
...
Typeshed currently has 1 unique allowlist entry for `PyYAML` when running stubtest in CI.
...
Typeshed currently has 83 unique allowlist entries for `aiofiles` when running stubtest in CI.
...
Typeshed currently has 25 unique allowlist entries for `chardet` when running stubtest in CI.
...
Typeshed currently has 4 unique allowlist entries for `contextvars` when running stubtest in CI.
...
Typeshed currently has 6 unique allowlist entries for `flake8-plugin-utils` when running stubtest in CI.
...
Typeshed currently has 7 unique allowlist entries for `fpdf2` when running stubtest in CI.
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 2,282
    - Unannotated parameters: 3,788
    - Explicit `Any` parameters: 2
...
Typeshed currently has 2 unique allowlist entries for `invoke` when running stubtest in CI.
...
Typeshed currently has 3 unique allowlist entries for `openpyxl` when running stubtest in CI.
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 2,723
    - Unannotated parameters: 587
    - Explicit `Any` parameters: 0
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 2,181
- Returns:
    - Annotated returns: 836
    - Unannotated returns: 339
    - Explicit `Any` returns: 1
    - Explicitly `Incomplete` (or partially `Incomplete`) returns: 19
- Variables:
    - Annotated variables: 4,225
    - Explicit `Any` variables: 0
    - Explicitly `Incomplete` (or partially `Incomplete`) variables: 3,515
- Class definitions:
    - Total class definitions: 571
    - Class definitions with `Any`: 0
...
Typeshed currently has 5 unique allowlist entries for `pyasn1` when running stubtest in CI.
...
Typeshed currently has 33 unique allowlist entries for `pyinstaller` when running stubtest in CI.
...
Typeshed currently has 8 unique allowlist entries for `pyvmomi` when running stubtest in CI.
...
Typeshed currently has 68 unique allowlist entries for `redis` when running stubtest in CI.
...
Typeshed currently has 12 unique allowlist entries for `requests` when running stubtest in CI.
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 494
    - Unannotated parameters: 348
    - Explicit `Any` parameters: 20
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 40
- Returns:
    - Annotated returns: 545
...
Typeshed currently has 1,059 unique allowlist entries for the stdlib when running stubtest in CI.
...
Typeshed currently has 25 unique allowlist entries for `tensorflow` when running stubtest in CI.
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 2,689
    - Unannotated parameters: 0
    - Explicit `Any` parameters: 9
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 3
- Returns:
    - Annotated returns: 1,847
    - Unannotated returns: 0
    - Explicit `Any` returns: 9
    - Explicitly `Incomplete` (or partially `Incomplete`) returns: 21
- Variables:
    - Annotated variables: 3,871
    - Explicit `Any` variables: 1
    - Explicitly `Incomplete` (or partially `Incomplete`) variables: 0
- Class definitions:
    - Total class definitions: 612
    - Class definitions with `Any`: 0
    - Class definitions marked as at least partially `Incomplete`: 0
