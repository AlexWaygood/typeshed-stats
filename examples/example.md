...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 1,208
    - Unannotated parameters: 280
    - Explicit `Any` parameters: 29
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 283
- Returns:
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 1,518
    - Unannotated parameters: 424
    - Explicit `Any` parameters: 14
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 0
- Returns:
    - Annotated returns: 735
    - Unannotated returns: 1
    - Explicit `Any` returns: 15
    - Explicitly `Incomplete` (or partially `Incomplete`) returns: 0
- Variables:
