...
Typeshed currently has 5 unique allowlist entries for `humanfriendly` when running stubtest in CI.
...
Typeshed currently has 988 unique allowlist entries for the stdlib when running stubtest in CI.
