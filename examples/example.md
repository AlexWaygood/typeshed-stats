...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 345
    - Unannotated parameters: 202
...
Typeshed currently has 67 unique allowlist entries for `passlib` when running stubtest in CI.
