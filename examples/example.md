...
- Returns:
    ...
    - Explicitly `Incomplete` (or partially `Incomplete`) returns: 0
- Variables:
    - Annotated variables: 3,115
    - Explicit `Any` variables: 1,868
    - Explicitly `Incomplete` (or partially `Incomplete`) variables: 197
- Class definitions:
    - Total class definitions: 1,332
