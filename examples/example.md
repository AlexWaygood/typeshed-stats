...
- Returns:
    - Annotated returns: 1,034
    - Unannotated returns: 555
    - Explicit `Any` returns: 19
    - Explicitly `Incomplete` (or partially `Incomplete`) returns: 262
- Variables:
