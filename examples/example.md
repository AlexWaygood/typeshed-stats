...
Typeshed currently has 51 unique allowlist entries for `reportlab` when running stubtest in CI.
...
Typeshed currently has 810 unique allowlist entries for the stdlib when running stubtest in CI.
