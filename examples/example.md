...
Typeshed currently has 112 unique allowlist entries for `setuptools` when running stubtest in CI.
...
Typeshed currently has 980 unique allowlist entries for the stdlib when running stubtest in CI.
