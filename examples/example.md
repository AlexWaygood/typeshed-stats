...
The latest version of `types-convertdate` aims to provide accurate annotations for `convertdate==2.4.1`.
...
Typeshed currently has 0 allowlist entries for `mysqlclient` when running stubtest in CI.
