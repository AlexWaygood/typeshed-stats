...
- Variables:
    ...
    - Explicitly `Incomplete` (or partially `Incomplete`) variables: 165
- Class definitions:
...
Typeshed currently has 1,050 unique allowlist entries for the stdlib when running stubtest in CI.
