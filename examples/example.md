...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 1,239
    - Unannotated parameters: 730
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 2,617
    - Unannotated parameters: 1,584
    - Explicit `Any` parameters: 35
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 246
- Returns:
    - Annotated returns: 956
    - Unannotated returns: 622
    - Explicit `Any` returns: 8
    - Explicitly `Incomplete` (or partially `Incomplete`) returns: 328
- Variables:
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 1,526
    - Unannotated parameters: 428
    - Explicit `Any` parameters: 14
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 0
- Returns:
    - Annotated returns: 739
    - Unannotated returns: 1
    - Explicit `Any` returns: 15
    - Explicitly `Incomplete` (or partially `Incomplete`) returns: 0
- Variables:
...
Typeshed currently has 858 unique allowlist entries for the stdlib when running stubtest in CI.
