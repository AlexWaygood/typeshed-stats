...
[https://github.com/architest/pymeeus](https://github.com/architest/pymeeus)
...
The latest version of `types-PyMySQL` aims to provide accurate annotations for `PyMySQL==1.2.*`.
...
Typeshed currently has 4 unique allowlist entries for `PyMySQL` when running stubtest in CI.
...
Typeshed currently has 4 unique allowlist entries for `WTForms` when running stubtest in CI.
...
Typeshed currently has 98 unique allowlist entries for `WebOb` when running stubtest in CI.
...
Typeshed currently has 2 unique allowlist entries for `auth0-python` when running stubtest in CI.
...
The latest version of `types-boltons` aims to provide accurate annotations for `boltons==26.1.*`.
...
The latest version of `types-cachetools` aims to provide accurate annotations for `cachetools==7.0.*`.
...
Typeshed currently has 19 unique allowlist entries for `cachetools` when running stubtest in CI.
...
The latest version of `types-cffi` aims to provide accurate annotations for `cffi==2.1.*`.

### Number of lines

851 (excluding blank lines)
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    ...
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 0
- Returns:
    - Annotated returns: 240
    - Unannotated returns: 85
    - Explicit `Any` returns: 8
    - Explicitly `Incomplete` (or partially `Incomplete`) returns: 1
- Variables:
    - Annotated variables: 255
    - Explicit `Any` variables: 0
...
[https://github.com/clarkperkins/click-shell](https://github.com/clarkperkins/click-shell)
...
The latest version of `types-click-spinner` aims to provide accurate annotations for `click-spinner==0.1.11`.
...
[https://github.com/timofurrer/colorful](https://github.com/timofurrer/colorful)
...
[https://github.com/fitnr/convertdate](https://github.com/fitnr/convertdate)
...
The latest version of `types-convertdate` aims to provide accurate annotations for `convertdate==2.5.1`.
...
## Info on typeshed's stubs for `datauri`

### Upstream repo URL

[https://github.com/eclecticiq/python-data-uri](https://github.com/eclecticiq/python-data-uri)
...
The latest version of `types-datauri` aims to provide accurate annotations for `datauri==1.1.*`.
...
Typeshed currently has 0 allowlist entries for `datauri` when running stubtest in CI.

### Pyright settings in CI: *strict*

All files in this stubs package are tested with the stricter pyright settings in typeshed's CI.

### Statistics on the annotations in typeshed's stubs for `datauri`
...
The latest version of `types-docker` aims to provide accurate annotations for `docker==7.2.*`.
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 1,614
    - Unannotated parameters: 200
    - Explicit `Any` parameters: 48
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 22
- Returns:
    - Annotated returns: 493
    - Unannotated returns: 99
...
The latest version of `types-docutils` aims to provide accurate annotations for `docutils==0.23`.

### Number of lines

5,690 (excluding blank lines)
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 2,466
    - Unannotated parameters: 688
...
- Variables:
    ...
    - Explicitly `Incomplete` (or partially `Incomplete`) variables: 223
- Class definitions:
    - Total class definitions: 500
    - Class definitions with `Any`: 1
    - Class definitions marked as at least partially `Incomplete`: 0
...
[https://foss.heptapod.net/openpyxl/et_xmlfile](https://foss.heptapod.net/openpyxl/et_xmlfile)
...
The latest version of `types-fanstatic` aims to provide accurate annotations for `fanstatic==1.7.*`.
...
Typeshed currently has 30 unique allowlist entries for `fanstatic` when running stubtest in CI.
...
The latest version of `types-flake8` aims to provide accurate annotations for `flake8==7.4.*`.
...
The latest version of `types-flake8-bugbear` aims to provide accurate annotations for `flake8-bugbear==26.9.9`.
...
Typeshed currently has 37 unique allowlist entries for `flake8-bugbear` when running stubtest in CI.
...
## Info on typeshed's stubs for `geojson`

### Upstream repo URL

[https://github.com/jazzband/geojson](https://github.com/jazzband/geojson)
...
The latest version of `types-geojson` aims to provide accurate annotations for `geojson==3.3.0`.
...
Typeshed currently has 2 unique allowlist entries for `geojson` when running stubtest in CI.

### Pyright settings in CI: *not strict*

This package is tested with pyright in typeshed's CI, but all files in this stubs package are excluded from the stricter pyright settings.

### Statistics on the annotations in typeshed's stubs for `geojson`
...
The latest version of `types-geopandas` aims to provide accurate annotations for `geopandas==1.1.4`.
...
Typeshed currently has 16 unique allowlist entries for `geopandas` when running stubtest in CI.
...
Typeshed currently has 98 unique allowlist entries for `gevent` when running stubtest in CI.
...
Typeshed currently has 2 unique allowlist entries for `google-cloud-ndb` when running stubtest in CI.
...
The latest version of `types-greenlet` aims to provide accurate annotations for `greenlet==3.5.*`.
...
The latest version of `types-gunicorn` aims to provide accurate annotations for `gunicorn==26.2.0`.
...
Typeshed currently has 7 unique allowlist entries for `gunicorn` when running stubtest in CI.
...
Typeshed currently has 17 unique allowlist entries for `hdbcli` when running stubtest in CI.
...
The latest version of `types-httplib2` aims to provide accurate annotations for `httplib2==0.32.0`.
...
## Info on typeshed's stubs for `httpretty`
...
The latest version of `types-httpretty` aims to provide accurate annotations for `httpretty==1.1.4`.
...
Typeshed currently has 0 allowlist entries for `httpretty` when running stubtest in CI.

### Pyright settings in CI: *strict*

All files in this stubs package are tested with the stricter pyright settings in typeshed's CI.

### Statistics on the annotations in typeshed's stubs for `httpretty`
...
The latest version of `types-ibm-db` aims to provide accurate annotations for `ibm-db==3.3.0`.

### Number of lines

367 (excluding blank lines)
...
Typeshed currently has 29 unique allowlist entries for `jsonschema` when running stubtest in CI.
...
Typeshed currently has 6 unique allowlist entries for `keyboard` when running stubtest in CI.
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    ...
    - Unannotated parameters: 929
    - Explicit `Any` parameters: 0
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 0
- Returns:
    - Annotated returns: 221
...
- Variables:
    ...
    - Explicit `Any` variables: 0
    - Explicitly `Incomplete` (or partially `Incomplete`) variables: 372
- Class definitions:
    - Total class definitions: 316
    - Class definitions with `Any`: 0
    - Class definitions marked as at least partially `Incomplete`: 0
...
[https://github.com/lidaobing/python-lunardate](https://github.com/lidaobing/python-lunardate)
...
The latest version of `types-lunardate` aims to provide accurate annotations for `lunardate==0.3.*`.
...
The latest version of `types-lupa` aims to provide accurate annotations for `lupa==2.8.*`.

### Number of lines

608 (excluding blank lines)
...
Typeshed currently has 2 unique allowlist entries for `mock` when running stubtest in CI.
...
The latest version of `types-mysqlclient` aims to provide accurate annotations for `mysqlclient==2.3.*`.

### Number of lines

1,285 (excluding blank lines)
...
Typeshed currently has 11 unique allowlist entries for `mysqlclient` when running stubtest in CI.
...
Typeshed currently has 169 unique allowlist entries for `openpyxl` when running stubtest in CI.
...
The latest version of `types-pika-ts` aims to provide accurate annotations for `pika==1.4.*`.
...
Partially generated using [mypy-protobuf==3.6.0](https://github.com/nipunn1313/mypy-protobuf/tree/v3.6.0) and libprotoc 35.1 on [protobuf v35.1](https://github.com/protocolbuffers/protobuf/releases/tag/v35.1) (python `protobuf==7.35.1`).
...
The latest version of `types-protobuf` aims to provide accurate annotations for `protobuf~=7.35.1`.
...
The latest version of `types-psycopg2` aims to provide accurate annotations for `psycopg2==2.9.13`.

### Number of lines

1,765 (excluding blank lines)
...
[https://github.com/bobthemighty/punq](https://github.com/bobthemighty/punq)
...
The latest version of `types-punq` aims to provide accurate annotations for `punq==0.8.*`.
...
Typeshed currently has 2 unique allowlist entries for `punq` when running stubtest in CI.
...
The latest version of `types-pyinstaller` aims to provide accurate annotations for `pyinstaller~=6.22.1`.

### Number of lines

798 (excluding blank lines)
...
Typeshed currently has 48 unique allowlist entries for `pyinstaller` when running stubtest in CI.
...
Typeshed currently has 32 unique allowlist entries for `pyjks` when running stubtest in CI.
...
[https://github.com/simlist/pyluach](https://github.com/simlist/pyluach)
...
Typeshed currently has 7 unique allowlist entries for `pynput` when running stubtest in CI.
...
## Info on typeshed's stubs for `pyphen`

### Upstream repo URL

[https://github.com/Kozea/Pyphen](https://github.com/Kozea/Pyphen)
...
The latest version of `types-pyphen` aims to provide accurate annotations for `pyphen==0.18.1`.
...
Typeshed currently has 0 allowlist entries for `pyphen` when running stubtest in CI.

### Pyright settings in CI: *strict*

All files in this stubs package are tested with the stricter pyright settings in typeshed's CI.

### Statistics on the annotations in typeshed's stubs for `pyphen`
...
Typeshed currently has 46 unique allowlist entries for `pyserial` when running stubtest in CI.
...
Typeshed currently has 7 unique allowlist entries for `python-dateutil` when running stubtest in CI.
...
Typeshed currently has 1 unique allowlist entry for `python-jose` when running stubtest in CI.
...
The latest version of `types-pytz` aims to provide accurate annotations for `pytz==2026.3.post1`.
...
Typeshed currently has 2 unique allowlist entries for `pytz` when running stubtest in CI.
...
Typeshed currently has 34 unique allowlist entries for `pywin32` when running stubtest in CI.
...
- Variables:
    - Annotated variables: 29,638
    - Explicit `Any` variables: 0
    - Explicitly `Incomplete` (or partially `Incomplete`) variables: 1,772
- Class definitions:
    - Total class definitions: 791
    - Class definitions with `Any`: 0
    - Class definitions marked as at least partially `Incomplete`: 0
...
Typeshed currently has 1 unique allowlist entry for `qrbill` when running stubtest in CI.
...
Typeshed currently has 9 unique allowlist entries for `qrcode` when running stubtest in CI.
...
The latest version of `types-reportlab` aims to provide accurate annotations for `reportlab==5.0.0`.
...
Typeshed currently has 50 unique allowlist entries for `reportlab` when running stubtest in CI.
...
## Info on typeshed's stubs for `scp`
...
The latest version of `types-scp` aims to provide accurate annotations for `scp==0.16.*`.
...
Typeshed currently has 0 allowlist entries for `scp` when running stubtest in CI.

### Pyright settings in CI: *strict*

All files in this stubs package are tested with the stricter pyright settings in typeshed's CI.

### Statistics on the annotations in typeshed's stubs for `scp`
...
The latest version of `types-setuptools` aims to provide accurate annotations for `setuptools==84.0.*`.
...
Typeshed currently has 70 unique allowlist entries for `setuptools` when running stubtest in CI.
...
- Parameters (excluding `self`, `cls`, `metacls` and `mcls`):
    - Annotated parameters: 932
    - Unannotated parameters: 244
    - Explicit `Any` parameters: 5
    - Explicitly `Incomplete` (or partially `Incomplete`) parameters: 14
- Returns:
    - Annotated returns: 774
    - Unannotated returns: 99
    - Explicit `Any` returns: 6
    - Explicitly `Incomplete` (or partially `Incomplete`) returns: 11
- Variables:
    - Annotated variables: 621
    - Explicit `Any` variables: 3
    - Explicitly `Incomplete` (or partially `Incomplete`) variables: 169
- Class definitions:
    - Total class definitions: 130
    - Class definitions with `Any`: 0
    - Class definitions marked as at least partially `Incomplete`: 0
...
## Info on typeshed's stubs for `tinycss2`

### Upstream repo URL

[https://github.com/Kozea/tinycss2](https://github.com/Kozea/tinycss2)
...
The latest version of `types-tinycss2` aims to provide accurate annotations for `tinycss2==1.5.1`.
...
Typeshed currently has 0 allowlist entries for `tinycss2` when running stubtest in CI.

### Pyright settings in CI: *strict*

All files in this stubs package are tested with the stricter pyright settings in typeshed's CI.

### Statistics on the annotations in typeshed's stubs for `tinycss2`
...
## Info on typeshed's stubs for `titlecase`

### Upstream repo URL

[https://github.com/ppannuto/python-titlecase](https://github.com/ppannuto/python-titlecase)
...
The latest version of `types-titlecase` aims to provide accurate annotations for `titlecase==2.4.*`.
...
Typeshed currently has 1 unique allowlist entry for `titlecase` when running stubtest in CI.

### Pyright settings in CI: *strict*

All files in this stubs package are tested with the stricter pyright settings in typeshed's CI.

### Statistics on the annotations in typeshed's stubs for `titlecase`
...
Typeshed currently has 2 unique allowlist entries for `ttkthemes` when running stubtest in CI.
...
The latest version of `types-tzdata` aims to provide accurate annotations for `tzdata==2026.*`.
...
[https://github.com/CourtBouillon/webencodings](https://github.com/CourtBouillon/webencodings)
...
The latest version of `types-webencodings` aims to provide accurate annotations for `webencodings==0.6.*`.
...
Typeshed currently has 0 allowlist entries for `webencodings` when running stubtest in CI.
...
The latest version of `types-xmldiff` aims to provide accurate annotations for `xmldiff==3.0.*`.

### Number of lines

301 (excluding blank lines)
...
- Variables:
    ...
    - Explicit `Any` variables: 0
    - Explicitly `Incomplete` (or partially `Incomplete`) variables: 45
- Class definitions:
    - Total class definitions: 24
    - Class definitions with `Any`: 0
    - Class definitions marked as at least partially `Incomplete`: 0
...
The latest version of `types-yt-dlp` aims to provide accurate annotations for `yt-dlp==2026.8.19`.
