...
Typeshed currently has 56 unique allowlist entries for `Authlib` when running stubtest in CI.
...
- Returns:
    - Annotated returns: 519
    - Unannotated returns: 391
    - Explicit `Any` returns: 4
    - Explicitly `Incomplete` (or partially `Incomplete`) returns: 10
- Variables:
    - Annotated variables: 568
...
## Info on typeshed's stubs for `pycountry`

### Upstream repo URL

[https://github.com/pycountry/pycountry](https://github.com/pycountry/pycountry)
...
Typeshed currently has 0 allowlist entries for `pycountry` when running stubtest in CI.

### Pyright settings in CI: *strict*

All files in this stubs package are tested with the stricter pyright settings in typeshed's CI.

### Statistics on the annotations in typeshed's stubs for `pycountry`
...
- Variables:
    ...
    - Explicit `Any` variables: 6
    - Explicitly `Incomplete` (or partially `Incomplete`) variables: 1,179
- Class definitions:
...
Typeshed currently has 846 unique allowlist entries for the stdlib when running stubtest in CI.
