...
Typeshed currently has 1 allowlist entry for `python-crontab` when running stubtest in CI.
...
Typeshed currently has 1,752 allowlist entries for the stdlib when running stubtest in CI.
